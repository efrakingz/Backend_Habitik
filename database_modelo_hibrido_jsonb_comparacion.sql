...
-- - canjes guarda el historial transaccional de recompensas
-- - historial_gamificacion centraliza XP/monedas por actividad
-- - daily_bonus_claims evita pagar mas de un bonus diario por usuario
...
-- ============================================================
-- 7.2 Historial gamificado y bonus diario
-- ============================================================
